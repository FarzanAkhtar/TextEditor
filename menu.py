...
class Menu():
    def __init__(self,windows , ai_settings, text_write, status_bar, toolbar):
        ...
        #images for sub-menu
        self.new_icon = tk.PhotoImage(file=self.ai_settings.exact_path('new.png'))
        self.open_icon = tk.PhotoImage(file=self.ai_settings.exact_path('open.png'))
        self.save_icon = tk.PhotoImage(file=self.ai_settings.exact_path('save.png'))
        self.save_as_icon = tk.PhotoImage(file=self.ai_settings.exact_path('save_as.png'))
        self.exit_icon = tk.PhotoImage(file=self.ai_settings.exact_path('exit.png'))

        #images for edit
        self.copy_icon = tk.PhotoImage(file=self.ai_settings.exact_path('copy.png'))
        self.paste_icon = tk.PhotoImage(file=self.ai_settings.exact_path('paste.png'))
        self.cut_icon = tk.PhotoImage(file=self.ai_settings.exact_path('cut.png'))
        self.clear_all_icon = tk.PhotoImage(file=self.ai_settings.exact_path('clear_all.png'))
        self.find_icon = tk.PhotoImage(file=self.ai_settings.exact_path('find.png'))

        #images for view
        self.tool_bar_icon = tk.PhotoImage(file=self.ai_settings.exact_path('tool_bar.png'))
        self.status_bar_icon = tk.PhotoImage(file=self.ai_settings.exact_path('status_bar.png'))

        #images for bg color
        self.light_default_icon =  tk.PhotoImage(file=self.ai_settings.exact_path('light_default.png'))
        self.light_plus_icon = tk.PhotoImage(file=self.ai_settings.exact_path('light_plus.png'))
        self.dark_icon = tk.PhotoImage(file=self.ai_settings.exact_path('dark.png'))
        self.red_icon = tk.PhotoImage(file=self.ai_settings.exact_path('red.png'))
        self.monokai_icon = tk.PhotoImage(file=self.ai_settings.exact_path('monokai.png'))
        self.night_blue_icon = tk.PhotoImage(file=self.ai_settings.exact_path('night_blue.png'))

        #sub-menues to main menu
        ...
        for count, item in enumerate(self.color_dict):
            self.color_theme.add_radiobutton(label= item,
              image= self.color_icons[count],
    ...
    def open_file(self, event=None):
        ...
        try:
            with open(self.url) as fr: #File read
                self.text_write.text_editor.delete(1.0, tk.END)
                self.text_write.text_editor.insert(1.0, fr.read())
